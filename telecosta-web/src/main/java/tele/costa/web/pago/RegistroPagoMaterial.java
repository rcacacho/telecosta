 ...
 * @author rcacacho
 */
@ManagedBean(name = "registroPagoMaterial")
@ViewScoped
public class RegistroPagoMaterial implements Serializable {

    private static final Logger log = Logger.getLogger(RegistroPagoMaterial.class);
